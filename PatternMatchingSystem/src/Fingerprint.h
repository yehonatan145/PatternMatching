...
fingerprint_t calc_fp(char* seq, int len, FieldVal* rn, FieldVal* r, fingerprint_t p);
fingerprint_t calc_fp_with_prefix(char* seq, int len, fingerprint_t prefix_fp, int prefix_len,
...
static inline fingerprint_t calc_fp_from_prefix_suffix(
	...
	// tl;dr: DO NOT REMOVE THE FIRST % p
